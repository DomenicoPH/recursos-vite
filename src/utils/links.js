...
export const tutoriales = [
    { url: 'https://youtu.be/XqFR2lqBYPs?si=HJfsLWnrABrPU77G', texto: 'HTML + CSS | FreeCodeCamp' },
    ...
    { url: 'https://youtu.be/4lAYfsq-2TE?si=-Ta2GmtUfp5Pzze6', texto: 'TO-DO APP con React y Typescript' },
    { url: 'https://youtu.be/yB4n_K7dZV8?si=p4p6u6CwlPtEan0k', texto: 'Node JS (Midudev)' },
    { url: 'https://youtu.be/ZpY5KdGQvwI?si=lLhu0k0pq1sTszEj', texto: 'API Rest con Node.js y Express' },
